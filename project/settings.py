...
ALLOWED_HOSTS = ALLOWED_HOSTS = ['smartcollegedmanhour-production.up.railway.app', 'localhost', '127.0.0.1']
...
'DEFAULT_RENDERER_CLASSES': [
        'rest_framework.renderers.JSONRenderer',  # بيحول الـ response لـ JSON
    ],
}
